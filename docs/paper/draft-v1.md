...
> *Figures captured against the live v3.1 application (root explorer and root card for `SH-L-M`); they therefore show six corpus badges. The current v3.3 release adds two further badges (Targum Writings, Ephrem — Other Works) to the same surfaces; figures to be recaptured at submission time. Source images: `docs/paper/figures/`.*
